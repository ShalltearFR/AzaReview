...
const TranslateSection2: TranslateSection = {
  fr: [
    "Codes actifs",
    "Lien copié",
    "[color=#FFCD6C]10%[/color] de cashback avec",
  ...
  en: [
    "Active codes",
    "Link copied",
    "[color=#FFCD6C]10%[/color] cashback with",
    "Spend less on HSR while supporting the site!",
    "By using these Eneba links for your purchases, you will greatly support us!",
    "Same prices as in-game but with 10% cashback to spend less next time.",
    "https://ene.ba/HSRAzanoEN",
    "Pay in MYR ",
    "to save an additional [b][color=#00ff00]22%[/color][/b] or ",
    "https://ene.ba/HSRAzanoEN2",
    "pay in Euro",
    "Fast and secure with Razer Gold",
    "Instant in-game delivery!",
    "(Hoyoverse partner)",
    "Your UID is enough, no need for personal credentials.",
    "If needed, visit ",
    "'s Twitch livestream for more information.",
  ],
};
