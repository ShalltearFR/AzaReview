...
const TranslateSection2: TranslateSection = {
  fr: [
    ...
    "Achetez sur le site ",
    "pour obtenir jusqu'à [b][color=#00ff00]16%[/color][/b] de réduction sur le pack à 100€.",
