    ...
    <>
      <div className="w-full h-full bg-[#253237]">
        <Parallax ref={parallax} pages={3}>
          ...
          >
            <>
              <div className="flex flex-col justify-center items-center w-96 h-96 bg-black rounded-3xl text-white">
                <p>Votre review Honkai : Star Rail</p>
                <p>Comment ça marche ?</p>
                <p>
                  Les personnages affichés seront ceux que vous aurez partagé en
                  jeu
                </p>
                <p>Entrez votre UID de jeu</p>
              </div>
              <div className="w-96 h-96 bg-black rounded-3xl text-white"></div>
            </>
          </ParallaxLayer>
