...
const CharacterList: React.FC<CharacterListProps> = ({
  ...
  return (
    <div
      data-aos="fade-down"
      className="flex flex-col mt-7 xl:flex-row xl:h-36 w-11/12 xl:w-[1350px] py-5 xl:py-0 bg-[#4E4A82] rounded-3xl lg:rounded-full items-center mx-auto shadow-2xl mb-[27px]"
    >
      <img
