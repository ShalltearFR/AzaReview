    ...
    <nav className="bg-[#030303] h-16 text-xl text-white">
      ...
      <ul className="flex px-7 items-center h-full">
        ...
        <div className="flex items-center gap-5 ml-auto">
          ...
          {/* <label className="flex gap-5 relative items-center w-72"> */}
          ...
          {/* <textarea
                ...
                className={`rounded-xl px-2 py-1 text-black ${
                  codeFocus ? "absolute h-16" : ""
                }`}
              /> */}
          {/* </label> */}
          {/* <button
              disabled={disableButton}
              className="flex items-center gap-2 px-3 py-1 rounded-full bg-green text-black disabled:bg-gray ml-auto"
              onClick={handleClick}
            >
              <span>{disableButton ? "Sauvegarde..." : "Sauvegarder"}</span>
              {disableButton && (
